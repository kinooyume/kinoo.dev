...
- **(sidebar)** mark component props as read-only - (984cb7c) - Martin Kinoo
#### Documentation
...
- **(atoms)** add SearchInput component - (a90fd54) - Martin Kinoo
#### Miscellaneous Chores
...
- **(version)** v0.19.0 - (be2f6e2) - github-actions[bot]
- **(version)** v0.19.0 - (60cf762) - github-actions[bot]
...
- **(ds)** migrate DSSidebar to SolidJS with search filtering - (871f0b0) - Martin Kinoo
...
- **(sidebar)** migrate to SolidJS with reactive patterns - (12ad942) - Martin Kinoo
- **(slider)** use createSelector for pagination active state - (69ebf02) - Martin Kinoo
- **(solid)** apply SolidJS best practices across all components - (1e3d833) - Martin Kinoo
...
- **(hero)** restore anime.js animations and remove scroll gating - (0106538) - Martin Kinoo
- **(tag)** reduce default size - (feff29a) - Martin Kinoo
- **(variables)** reduce default font size - (c4910d5) - Martin Kinoo
#### Features
- **(colors)** add full color scales, rename card vars to surface, and use DS tokens - (9ee440b) - Martin Kinoo
- **(contact)** use Button component, fix validation, and update form UX - (f8ced4e) - Martin Kinoo
- **(contact)** redesign form with dark theme, grid layout, and updated copy - (bc98c33) - Martin Kinoo
...
- **(tag)** theme tags with section accent colors - (481727f) - Martin Kinoo
#### Miscellaneous Chores
- **(version)** v0.16.0 - (07e3941) - github-actions[bot]
#### Refactoring
- **(hero)** remove unused anime.js timelines from heroAnime - (fc644fc) - Martin Kinoo
...
#### Miscellaneous Chores
- **(version)** v0.15.0 - (8ef5290) - github-actions[bot]
...
- **(version)** v0.12.0 - (becc163) - github-actions[bot]
#### Refactoring
